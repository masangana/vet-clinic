...
SELECT vets.name AS "VET NAME", COUNT(DISTINCT visits.animal_id) 
    AS "NUMBER OF ANIMALS" FROM vets
    JOIN visits
    ON vets.id = visits.vet_id
...
SELECT vets.name AS "VET NAME", animals.name 
    AS "ANIMAL NAME", visits.date_of_visit AS "DATE OF VISIT" FROM vets
    JOIN visits
    ON vets.id = visits.vet_id
    JOIN animals
...
SELECT vets.name AS "VET NAME", visits.date_of_visit 
    AS "DATE OF VISIT", animals.name AS "ANIMAL" FROM vets
    JOIN visits
    ON vets.id = visits.vet_id
    JOIN animals
    ON visits.animal_id = animals.id
...
SELECT animals.name AS "NAME",
    animals.date_of_birth AS "BIRTHDAY",
...
SELECT animals.name AS "ANIMAL NAME",
    animals.species_id AS "SPECIES ID",
